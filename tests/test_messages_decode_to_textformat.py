...
class TestDecodeTextFormat:
    ...
    def test_everything(self, db:  MySQLConnection):
        ...
        assert (self.textformat(db, message.SerializeToString(), 'foo.bar.test.everything.ComplexNestedMessage') ==
                ('all_fixed_32: {\n'
                 ...
                 ' some_bytes: "\x01\x02\x03\x04\x05\x06\x07\x08\t"\n'
                 '}\n'
                 'level1: {\n'
                 ' level2: {\n'
                 '  level3: {\n'
